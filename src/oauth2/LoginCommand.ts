...
const helpAfter =
  trim(`Please open the login page provided in a browser.  Once you've completed the login, you'll be provided 
a custom code.  This code will be used to authorize the CLI with your Yahoo! account.`);
